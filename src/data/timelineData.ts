...
const timelineData = {
    ...
    1164: [
        ...
        },
        {
            ...
            description: "Everyone meets together outside Pale to discuss the attack on the Pannion Domin.",
        ...
        },
        {
            ...
            name: "Outlook",
            icon: eventIcons.death,
            description: "Toc meets the leader of the Pannion Domin the Pannion Seer who is a Jaghurt, Toc is captured by the Materon and is tortured while being constantly healed. ",
            char: [7],
            loc: [545.165, 104.38],
            area: 1,
        },
        ...
        },
        {
            ...
            name: "Bones",
            icon: eventIcons.city,
            description: "Adjunct Tavores army heads off to destory Shai'ik Army and to get revenge on Pormqual.",
