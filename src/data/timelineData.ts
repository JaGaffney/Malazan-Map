...
const timelineData = {
    ...
    1159: [
        {
            ...
            description: "Karsa sets off on his journey. Timeline is inconsistent, this should happen in 1162-1163 Burn's Sleep. Doesn't really matter to the story",
            char: [39],
            loc: [532.77, 30.7],
            area: 1,
        },
        {
            ...
            name: "Tiste Edur",
            icon: eventIcons.tribal,
            description: "Birthplace of the Sengars.",
            char: [38, 56, 57, 58, 59],
            loc: [16.815, 213.3],
            area: 6,
        },
    ...
    1163: [
        ...
        //     name: "Return home",
        //     icon: eventIcons.travelBoat,
        //     description: "Apsalar wishes to return home.",
        //     char: [2, 11, 12, 15],
        //     loc: [517.34, 81.14],
        //     area: 1,
        // },
        {
            ...
            icon: eventIcons.tribal,
            description: "Karsa and Leomen Leoman of the Flails are rescued by Tovald Nom and the 2 of them make there way to Raraku to meet Sha'ik.",
            char: [39, 50],
            loc: [398.25, 52.19],
            area: 2,
        },
    ...
    1169: [
        ...
        },
        {
            ...
            char: [16, 14, 15, 23, 25, 28, 30, 31, 33, 48, 52],
            loc: [522.65, 84.28],
            area: 1,
        },
    ],
