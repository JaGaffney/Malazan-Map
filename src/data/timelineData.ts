...
const timelineData: ITimelineData = {
    ...
    1159: [
        ...
        },
        {
            ...
            name: "Expansion",
            icon: eventIcons.battle,
            description: ["The Edur begin their expansion campign killing and enslaving anyone they encounter due to Rhulards power."],
            citation: "Chapter 15 - Scene 6",
            char: [38, 56, 57, 58, 59],
            loc: [22.5, 228.3],
        },
        {
