...
const timelineData: ITimelineData = {
    ...
    1166: [
...

        {
            ...
            icon: eventIcons.mask,
            description: [
                "Toc teaches the Awl how to craft stone weapons that he leant from Tool in MOI, and he helps Redmask plan an attack on the Lehterii",
                "Redmask tell the story of Bast Fulmar, Bast Fulmar, the Valley of Drums, was believed by the Letherii to be a historical site of battle between the Awl and K’Chain Che’Malle. The truth, it is the site where Shamans of the Antler cast magic that killed the land so they could leave and wage war, ",
                "Bast Fulmar may be the site of the Tellann Ritual, where Imass gathered to become T’lan Imass, Magic is dead in Bast Fulmar, Redmask plans to take advantage of this against the Letherii",
                "The Battle of Bast Fulmar begins and the Awl forces the Letherii to retreat due to their warlocks not being able to use magic. Redmask does not pursue the weakened forces.",
            ],
            citation: "Chapter 12 - Scene 10",
            char: [93, 7, 82],
            loc: [98.0, 248.3],
        },

        {
            ...
            icon: eventIcons.shore,
            description: [
                "Atri-Preda Yan Tovis arrives at Boaral Keep and finds 200 Shake witches and warlocks who have cursed the local area. Yan Tovis demands the witches to end the curse, using her authority as the Twilight, Shake Princess.",
                "The Shake witches bow their heads and reveal that her Queen mother was killed by the demon spirit-god [Hannan Mosag] had controlled to conquer Letheras The Shake witches also reveal Yan Tovis is to be betrothed to Shake Brullyg of Second Maiden Fort, but they don’t know if he remains there because the shore is blind to the sea for almost a month",
                "Yan Tovis decides to go retrieve the Master of Arms who went to investigate a mystery of disappearing fishermen and dark voices from the sea. The Master of Arms is Yedan Derryg known as The Watch who is her half-brother.",
                "Yan Tovis rides to the shore and meets Yedan Derryg, he feels elt that he was summoned to the shore. The air had been still, but now it rains for the first time. The horizon glows from burning Malazan ships slowly approaching, Yan Tovis believes the Malazan has come to punish the Letherii for the murder of Malazan subjects",
                "",
                "'They are here. On this shore. The Malazans are on our shore'",
                ,
            ],
            citation: "Chapter 12 - Scene 13",
            char: [63, 96],
            loc: [5.0, 236.3],
        },

        {
            id: uuidv4(),
            book: 107,
            name: "The Malazans are on our shore",
            icon: bookIcons.theBonehunters,
            description: [
                "Tavore gives a speach to her men",
                "'Compassion is never enough. Nor is the hunger of vengeance What awaits you in the dusk of the old worlds passing, shall go… unwitnessed, We shall be our own witness, and that will be enough. It must be enough. It must ever be enough.'",
                "The words had awakened the soldiers, to rail against the injustice of being unwitnessed, not a single soldier deserted",
                "Tavore had ordered to burn their transport ships to send the message that the Bonehunters have arrived to the Letherii Empire",
                "The Bonehunters begin their invasion by sending squads of soldiers inland in squads.",
            ],
            citation: "Chapter 13 & Chapter 14",
            char: [11, 12, 22, 42, 43, 44, 45, 46, 53, 65, 66, 68, 76],
            loc: [8.5, 225.3],
        },

        {
            id: uuidv4(),
            book: 107,
            name: "Bluerose mountains part 2",
            icon: eventIcons.tisti,
            description: ["The group is traveling to the Blue Rose Tiste Andii and find that they have been killed, Fear believes it was Clip"],
...

        {
            ...
            icon: eventIcons.mask,
            description: [
                "Redmask blows his horn, giving the signal for Masarch to lead 600-700 lancers to attack the Letherii camp",
                "Toc wielded his bow, rode his horse to go behind a third wave of sorcery, leaped over a trench, fired an arrow, and landed just dodging the fourth silver veined wave of sorcery. he mage was decapitated, smoke rising instead of blood",
                "Morning, Brohl Handar approaches Atri-Preda Bivatt who is still mind blown that an archer [Toc] decapitated two Letherii while riding horseback and leaping over a trench",
                "Hundreds of Letherii and 82 Edur died, compared to the thousands the Awl had lost",
            ],
            citation: "Chapter 16 - Scene 15",
            char: [93, 7, 82],
            loc: [97.0, 246.3],
        },

        {
            ...
            icon: bookIcons.theBonehunters,
            description: [
                "Beak and Faradan Sort are providing inteligence for each of the Malazan squads",
                "Hellians group is going from Tavern to Tavern, killing anyone in charge, which the locals like due to having their debts removed",
                "Bottle is using his warren to scout with the local animals, the Letherii magic is primitive, not as ancient as spirit bonding, and choked by chaos",
                "Cpl. Stormy’s glad that Tavore finally let the Bonehunters loose and fight like they were trained to do for years",
                "Fiddler is using his Moranth Munnitions which is laying waste to the Letherii",
            ],
            citation: "Chapter 17",
            char: [12, 43, 44, 45, 53, 76],
            loc: [17.5, 233.3],
        },

        {
            ...
            icon: bookIcons.theBonehunters,
            description: [
                "Shurq Elalle’s herbs was getting stale, she’s starting to smell, Shurq looks at Adjunct Tavore Paran, Tavore could look more feminine if she wanted to, but chose to look boring. She looked like she has neither heroic or lustful qualities to her appearance, a distinct lack of personality. Shurq looks at Tavore’s aids, think she keeps the pretty ones close",
                "Tavore asks Shurq about the Emperor, Explains that his palace staff, secret police, and economic staff are all Letherii. The Edur status in the empire is “wobbly”",
                "Atri-Preda Yan Tovis and Watch Yedan Derryg enter the room, Yan Tovis declares herself Queen of the Shake, that she chooses her own Rise [King], and orders Yedan to throw Shake Brullyg out of the window, Tavore sees that Yan Tovis’ people appear to be refugees, Yan Tovis explains they were subjugated by the Letheri. Shake Brullyg demands protection, Tavore says the Malazans won’t stay here much longer. The sheets of ice that threaten the island will melt on their own",
            ],
            citation: "Chapter 17 - Scene 22",
            char: [22, 42, 46, 63, 65, 66, 68, 96],
            loc: [8.5, 225.3],
        },

        {
            ...
            icon: eventIcons.mask,
            description: [
                "The Drene forces are chasing Redmask and the Awl who lost the Battle of Pradegar, Redmask was unprepared for the unseasonal heavy rainstorm the past three days. The Letherii supply train from Drene is disrupted, the army will not fight or be loyal without food",
                "Toc watches as Redmask orders the Awl to dismantle most of the wagons to create platforms for the few remaining wagons to travel over the mud. Torrent rides up next to Toc, calls mages cowards for fighting in the back, and continues to distrust Toc while threatening to slit his throat",
                "Redmask has strangled to death a Renfayar elder who knew Redmask’s father and his identity Redmask has faith in his K’Chain Che’Malle guardians for victory",
            ],
            citation: "Chapter 19 - Scene 6",
            char: [93, 7, 82],
            loc: [94.0, 247.3],
        },

        {
            id: uuidv4(),
            book: 107,
            name: "Malazan attack - Beak",
            icon: bookIcons.theBonehunters,
            description: [
                "The Malazan forces regroup in a town and find out that only Hellians squad has had any success in taking over Letheras",
                "The group is ambushed by an Edur force and a lot of Malazans are killed",
                "The Malazans manage to hold the Edur off but a larger force is gathering to attack at sunrise and that the Malazans wont hold out until Adjunct Tavores forces arrive as backup",
                "Letherii mages arrive and attack the Malazans and the Edur",
                "Beak opens all of his warrens and creates a barrier to protect the forces, Fiddler tells the Edur to get inside the shield. Beaks power kills the attacking mages and decimates the Letherii forces. The shield dyes the Malazan forces white, He dies in the process.",
                "Hood personally arrives to bring Beak through his gate The entrance to Hood’s Gate is white. The gate is made of white marble, inside was swirling silver light, Hood proclaims he is also waiting for another person that will join him soon.",
            ],
            citation: "Chapter 21 & Chapter 22",
            char: [12, 43, 44, 45, 53, 76, 81],
            loc: [27.5, 234.3],
        },

        {
            ...
            icon: eventIcons.mask,
            description: [
                "Bivatt watches as the Letherii and Awl kill each other in a seething mass of mud and blood, o the west, the K’Chain Che’Malle were slaughtering the Letherii until both were driven back by arrows and a spear lodged in the female’s left thigh Instead of feeling victorious, she hates the Awl for not fleeing. A third of her army is dead",
                "Redmask pulls himself onto a horse and aggressively pulls the reins to drive it to the east flank where the K’Chain Che’Malle are, Redmask lost his cadaran whip, but still wields his damaged rygtha crescent axe. He feels eager to kill Bivatt, and encouraged by reuniting with the KCCM.",
                "Sag’Churok cuts the head off Redmask’s horse by the neck, Redmask is knocked off as the headless horse runs a few strides before collapsing, Sag’Churok grabs Redmask with its foot, crushes his chest with the talon, and tosses him in the air to bisect Redmask through the right should The arms spins away gripping the axe, Redmask flops to the floor dead",
                "Toc watches as the K’Chain Che’Malle pokes at Redmask’s corpse, then walk northeast. Toc considers euthanizing the ~20 Awl children as Letherii skirmishes ride towards them Toc then sees an unknown army approach and thinks it’s the Bolkando alliance, Toc gallops towards the approaching Letherii skirmishers as he’s 50 steps away he starts firing arrows",
                "Torrent leads the children up a gentle slope towards the unknown army, knowing it might be to their deaths Torrent decides to turn around and witness Toc’s courage because Toc deserves that much respect from him.",
                "Toc kills multiple of the Letherii force before he is slain for the 3rd time.",
                "The Whiteface Barghast clans watch from above, as the Awl children approach them and the Letherii and Awl battle atop a lakebed. Onos Toolan the new warleader of the Barghast after being made mortal and his wife Hetan and his Sister Kilava watch as Toc was slain",
                "Tool realizes the horse warrior is Toc the Younger and collapses down, wailing and clawing at his face. Hetan cradles him in her body, The Whiteface Baghast slay all of the Letherii they see",
                "Hood, High King of Death, Collector of the Fallen. The other person he waits for is Toc the Younger, Toc asks why he still has one eye, Hood genuinely has no idea and blames the Wolves of Winter",
            ],
            citation: "Chapter 22 - Scene 33",
            char: [93, 7, 82, 18, 34, 72, 81],
            loc: [92.0, 247.3],
        },

        {
            id: uuidv4(),
            book: 107,
            name: "Malazan attack - Letheras",
            icon: bookIcons.theBonehunters,
            description: ["The Bonehunters make their way to attack Letheras"],
            citation: "Chapter 24 Scene",
            char: [12, 42, 43, 44, 45, 53, 76, 81],
            loc: [28.5, 235.3],
        },

        {
            ...
            name: "Letheras",
            icon: eventIcons.city,
            description: ["Everything that happens until the end of the book in Letheras"],
            citation: "Chapter 24 - end",
            char: [4, 12, 22, 24, 30, 38, 39, 42, 43, 44, 45, 46, 53, 54, 56, 57, 58, 59, 60, 61, 62, 63, 64, 65, 66, 67, 73, 76, 81, 96],
            loc: [30.97, 237.9],
        },
    ],
    1167: [
