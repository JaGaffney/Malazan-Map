...
export const { update, reset, updateActiveID, updateActiveData, updateMoon, updateCity, updateActiveCharacter, resetActiveCharacter, updateActiveBooks, resetActiveBooks } = filterSlice.actions;
