...
export default function WorldMap() {
    ...
    return (
        <div className="worldmap" >
            ...
            <img className={`worldmap-map ${!areaData.includes(1) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/genabackis.png"} />
            <img className={`worldmap-map ${!areaData.includes(2) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/seven_cities.png"} />
            <img className={`worldmap-map ${!areaData.includes(3) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/quon_tali.png"} />
            <img className={`worldmap-map ${!areaData.includes(4) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/jacuruku.png"} />
            <img className={`worldmap-map ${!areaData.includes(5) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/stratem.png"} />
            <img className={`worldmap-map ${!areaData.includes(6) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/lether.png"} />
            <img className={`worldmap-map ${!areaData.includes(7) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/bael.png"} />
            <img className={`worldmap-map ${!areaData.includes(8) && "worldmap-dark"} `} src={process.env.PUBLIC_URL + "/images/small/genostel.png"} />
